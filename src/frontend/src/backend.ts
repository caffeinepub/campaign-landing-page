...
export class Backend implements backendInterface {
    ...
    async addSupporter(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSupporter(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSupporterCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSupporterCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
